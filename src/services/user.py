...
class UserService:
    ...
    async def create_users(self, data: list[CreateUser], created_by: User) -> list[User]:
        """Create a new user.

        Args:
            data (CreateUser): Data required to create a new user.
        ...
        try:
            async with self.uow_factory as uow:
                ...
                for user_data in data:
                    ...
                    users.append(user)
                await uow.users_repo.bulk_create(users)
